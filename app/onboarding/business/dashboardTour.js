...
const DashboardTour = ({ onComplete, onPrev }) => {
  return (
    <div>
      ...
      <p>Great job setting up your account! Let's take a quick tour of your new dashboard.</p>
      <div className="mb-3">
        <h5>Analytics Overview</h5>
        <p>Track your deals' performance and customer engagement.</p>
      </div>
      <div className="mb-3">
      ...
      <div className="alert alert-success" role="alert">
        You're all set! If you have any questions, our support team is here to help.<br></br>
